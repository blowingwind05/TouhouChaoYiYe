    ...
    playing:begin
        ...
        if(prev_game_state != game_state)begin
            ...
            if(rfclk == 1 && prev_rfclk == 0)begin
                ...
                5:begin
                    if(i < 5'd16)begin
                        if(EnemySniperSingleBullet[i][17:16] == 2'd1 || EnemySniperSingleBullet[i][17:16] == 2'd2)begin
                            if(x < (EnemySniperSingleBullet[i][7:0] > 8'd11 ? 8'd21 : EnemySniperSingleBullet[i][7:0] + 8'd10))begin
                                if(rdaddr < (8'd150 - EnemySniperSingleBullet[i][7:0] - 8'd10 + x)*8'd200 + EnemySniperSingleBullet[i][15:8] + 8'd10)begin
                                    vramwe <= txdata[0];
                                    txaddr <= txaddr + 1;
                                    rdaddr <= rdaddr + 1; 
                                    vramwdata <= txdata[15:4];
                                    ...
                                    vramwe <= 0;
                                    rdaddr <= (8'd151 - EnemySniperSingleBullet[i][7:0] - 8'd10 + x)*8'd200 + EnemySniperSingleBullet[i][15:8] - 8'd11;
                                    x <= x + 1;
                                end
                            end
                            else begin
                                vramwe <= 0;
                                rdaddr <= (8'd150 - EnemySniperSingleBullet[i+1][7:0] - 8'd10)*8'd200 + EnemySniperSingleBullet[i+1][15:8] - 8'd11;
                                txaddr <= enemysniperred;
                                i <= i + 1;
                                x <= 0;
                            end
                        ...
                        vramwe <= 0;
                        rdaddr <= (8'd150 - OddBullet[0][7:0] -8'd2)*8'd200 + OddBullet[0][15:8] - 8'd3;
                        rdprogress <= rdprogress + 1;
                        txaddr <= bulletyellow;
                        x <= 0;
                        i <= 0;
                        ...
                        if(OddBullet[i][17:16] == 2'd1 || OddBullet[i][17:16] == 2'd2)begin
                            if(x < (OddBullet[i][7:0] > 8'd3 ? 8'd5 : OddBullet[i][7:0] + 8'd2))begin
                                if(rdaddr < (8'd150 - OddBullet[i][7:0] -8'd2 + x)*8'd200 + OddBullet[i][15:8] + 8'd2)begin
                                    ...
                                    vramwe <= 0;
                                    rdaddr <= (8'd151 - OddBullet[i][7:0] -8'd2 + x)*8'd200 + OddBullet[i][15:8] - 8'd3;
                                    x <= x + 1;
                                end
                            end
                            else begin
                                vramwe <= 0;
                                rdaddr <= (8'd150 - OddBullet[i+1][7:0] -8'd2)*8'd200 + OddBullet[i+1][15:8] - 8'd3;
                                txaddr <= bulletyellow;
                                i <= i + 1;
                                x <= 0;
                            end
                        ...
                        if(EvenBullet[i][17:16] == 2'd1 || EvenBullet[i][17:16] == 2'd2)begin
                            if(x < (EvenBullet[i][7:0] > 8'd3 ? 8'd5 : EvenBullet[i][7:0] + 8'd2))begin
                                if(rdaddr < (8'd150 - EvenBullet[i][7:0] - 8'd2 + x)*8'd200 + EvenBullet[i][15:8] + 8'd2)begin
                                    ...
                                    vramwe <= 0;
                                    rdaddr <= (8'd151 - EvenBullet[i][7:0] - 8'd2 + x)*8'd200 + EvenBullet[i][15:8] - 8'd3;
                                    x <= x + 1;
                                end
                            end
                            else begin
